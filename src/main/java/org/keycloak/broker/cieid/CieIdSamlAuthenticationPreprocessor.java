...
/**
 * CIE ID-specific SAML authentication preprocessor that modifies AuthnRequest and LogoutRequest
 * to comply with CIE ID requirements:
 ...
 */
public class CieIdSamlAuthenticationPreprocessor implements SamlAuthenticationPreprocessor {

    public static final String PROVIDER_ID = "cieid-saml-preprocessor";
    ...
    public AuthnRequestType beforeSendingLoginRequest(AuthnRequestType authnRequest,
        ...
        if (!"true".equals(authSession.getClientNote(CieIdIdentityProvider.CIEID_FLOW_MARKER))) {
            return authnRequest;
        }
        ...
        // CIE ID: Modify Issuer element - add NameQualifier and Format attributes
        ...
        // CIE ID: Modify NameIDPolicy - add SPNameQualifier attribute
        if (authnRequest.getNameIDPolicy() != null) {
            authnRequest.getNameIDPolicy().setSPNameQualifier(issuerURL);
        }

        // Store the request IssueInstant in the auth session for CIE ID response validation
        if (authnRequest.getIssueInstant() != null) {
            authSession.setClientNote(CieIdIdentityProvider.CIEID_REQUEST_ISSUE_INSTANT,
    ...
    public LogoutRequestType beforeSendingLogoutRequest(LogoutRequestType logoutRequest,
        ...
        if (!"true".equals(userSession.getNote(CieIdIdentityProvider.CIEID_FLOW_MARKER))) {
